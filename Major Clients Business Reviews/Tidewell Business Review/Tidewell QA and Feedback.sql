...
set @iHOS = 299 --Tidewell (201503,201508)


 IF OBJECT_ID('reports_bic.dbo.TidewellQAregionalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellQAregionalQuestions; 

create table reports_bic.dbo.TidewellQAregionalQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.[dbo].[TidewellFeedback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[TidewellFeedback]; 
  
  CREATE TABLE reports_bic.[dbo].[TidewellFeedback](
	[iOID] [int] NOT NULL,
...
IF OBJECT_ID('reports_bic.dbo.TidewellQANationalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellQANationalQuestions; 

create table reports_bic.dbo.TidewellQANationalQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.dbo.TidewellQAClientQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellQAClientQuestions; 

create table reports_bic.dbo.TidewellQAClientQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.dbo.TempTidewellRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempTidewellRegional; 

create table  reports_bic.dbo.TempTidewellRegional (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
IF OBJECT_ID('reports_bic.dbo.TempTidewellClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempTidewellClient; 

create table  reports_bic.dbo.TempTidewellClient (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
--10 = Hospice Level
--20 = Region Level
--30 = Sub Region Level (Tidewell is only one using it)
--40 = Client Level
...
--get Notes
  ...
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.TidewellQANationalQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into  reports_bic.dbo.TempTidewellRegional
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into  reports_bic.dbo.TempTidewellClient
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into reports_bic.[dbo].[TidewellFeedback]
...
IF OBJECT_ID('reports_bic.dbo.TidewellRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellRegional; 

create table  reports_bic.dbo.TidewellRegional (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Tidewell Region Level' as info
insert into  reports_bic.dbo.TidewellRegional
select ROW_NUMBER() over (order by Provider) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempTidewellRegional
--get Notes

declare @regcnt as int,@rgn_step as int,@regionname char(100)

select @regcnt=count(*) from reports_bic.dbo.TidewellRegional
...
declare @providername varchar(100)
	...
	select @gmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.TidewellRegional where seqno=@rgn_step
	select @providername=  Provider from reports_bic.dbo.TidewellRegional where seqno=@rgn_step


  select @perQ1 = pQ1 from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ2 = pQ2 from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ4m = pQ4m from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ4x = pQ4x from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ4f = pQ4f from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ5m = pQ5m from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ5x = pQ5x from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ5f = pQ5f from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ6m = pQ6m from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ6x = pQ6x from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ6f = pQ6f from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ7m = pQ7m from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ7x = pQ7x from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 
  select @perQ7f = pQ7f from reports_bic.dbo.TidewellRegional where seqno=@rgn_step 



  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Equipment',@perQ1,1-@perQ1,null,@gmonth,@providername);
  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Instruction',@perQ2,1-@perQ2,null,@gmonth,@providername);
  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Delivery Person',@perQ4m, @perQ4f, @perQ4x,@gmonth,@providername);
  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Phone Service',@perQ5m, @perQ5f, @perQ5x,@gmonth,@providername);
  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Timely Delivery',@perQ6m, @perQ6f, @perQ6x,@gmonth,@providername);
  insert into reports_bic.dbo.TidewellQAregionalQuestions values ('Timely Pickup',@perQ7m, @perQ7f, @perQ7x,@gmonth,@providername);
...
IF OBJECT_ID('reports_bic.dbo.TidewellClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellClient; 

create table  reports_bic.dbo.TidewellClient (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Tidewell Client Level' as info
insert into  reports_bic.dbo.TidewellClient
select ROW_NUMBER() over (order by Client) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempTidewellClient
--get Notes

declare @clientcnt as int,@client_step as int

select @clientcnt=count(*) from reports_bic.dbo.TidewellClient
...
declare @clientname varchar(100)
	...
	select @gcmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.TidewellClient where seqno=@client_step
	select @cprovidername=  Provider from reports_bic.dbo.TidewellClient where seqno=@client_step
	select @clientname= client from reports_bic.dbo.TidewellClient where seqno=@client_step


  select @percQ1 = pQ1 from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ2 = pQ2 from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ4m = pQ4m from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ4x = pQ4x from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ4f = pQ4f from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ5m = pQ5m from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ5x = pQ5x from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ5f = pQ5f from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ6m = pQ6m from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ6x = pQ6x from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ6f = pQ6f from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ7m = pQ7m from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ7x = pQ7x from reports_bic.dbo.TidewellClient where seqno=@client_step 
  select @percQ7f = pQ7f from reports_bic.dbo.TidewellClient where seqno=@client_step 



  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Equipment',@percQ1,1-@percQ1,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Instruction',@percQ2,1-@percQ2,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Delivery person',@percQ4m, @percQ4f, @percQ4x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Phone Service',@percQ5m, @percQ5f, @percQ5x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Timely Delivery',@percQ6m, @percQ6f, @percQ6x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.TidewellQAClientQuestions values ('Timely Pickup',@percQ7m, @percQ7f, @percQ7x,@gcmonth,@cprovidername,@clientname);
