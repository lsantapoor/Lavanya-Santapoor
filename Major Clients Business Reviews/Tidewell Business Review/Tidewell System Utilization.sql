...
set @iHOS = 299 --Tidewell Hospice (201405,201503,201508,201601)
...
IF OBJECT_ID('reports_bic.dbo.TidewellSystemUtil', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TidewellSystemUtil; 

CREATE TABLE reports_bic.dbo.TidewellSystemUtil(
	[sHospice] [varchar](128) NULL,
	[sRegion] [varchar](128) NULL,
	[sClient] [varchar](128) NULL,
	[sProvider] [varchar](128) NULL,
...
insert into reports_bic.dbo.TidewellSystemUtil
