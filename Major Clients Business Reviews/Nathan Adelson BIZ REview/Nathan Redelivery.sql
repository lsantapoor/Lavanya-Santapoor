...
6 -  
*/
 IF OBJECT_ID('reports_bic.[dbo].[NathanRedelivery]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[NathanRedelivery]; 


CREATE TABLE reports_bic.[dbo].[NathanRedelivery](
    smonth [varchar](12),
...
\*-----------------------------------*/
	insert into reports_bic.dbo.NathanRedelivery
