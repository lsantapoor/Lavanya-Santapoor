...
IF OBJECT_ID('reports_bic.dbo.AmedisysSystemUtil', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.AmedisysSystemUtil; 

CREATE TABLE reports_bic.dbo.AmedisysSystemUtil(
	[sHospice] [varchar](128) NULL,
	[sRegion] [varchar](128) NULL,
	[sClient] [varchar](128) NULL,
	[sProvider] [varchar](128) NULL,
...
insert into reports_bic.dbo.AmedisysSystemUtil
