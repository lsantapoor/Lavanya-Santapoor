...
6 -  
*/
 IF OBJECT_ID('reports_bic.[dbo].[TidewellRedelivery]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[TidewellRedelivery]; 


CREATE TABLE reports_bic.[dbo].[TidewellRedelivery](
    smonth [varchar](12),
...
\*-----------------------------------*/
	insert into reports_bic.dbo.TidewellRedelivery
