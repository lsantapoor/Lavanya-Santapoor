...
IF OBJECT_ID('reports_bic.dbo.ServiceLevelHistorical', 'U') IS NOT NULL 
DROP TABLE  reports_bic.dbo.ServiceLevelHistorical; 
CREATE table reports_bic.dbo.ServiceLevelHistorical
(
	dmeID int null,
	siteID int null,
	OrderId int null,
...
return
  ...
  IF OBJECT_ID('reports_bic.dbo.OrderManagementDataHistorical', 'U') IS NOT NULL BEGIN
	DROP TABLE reports_bic.dbo.OrderManagementDataHistorical
  END

	create table reports_bic.dbo.OrderManagementDataHistorical (
		[Order Id] INT,
		[Status] varChar(64),
		[Type] varChar(64),
		[Date Stamp] datetime,
		...
		[ClientID] INT,
		[SiteID] INT,
		[Address 1] varChar(128),
		[Address 2] varChar(128),
		[City] varChar(64),
		[State] varChar(64),
		[Zip Code] varChar(64),
	...
	--SUBSTRING(CONVERT(VARCHAR(20),(ScheduleEnd - dtCompleted),120),12,8) 
