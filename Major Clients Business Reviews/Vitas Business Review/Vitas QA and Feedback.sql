...
set @iHOS = 86 --(BN-) Vitas (201401, 201506, 201507, 201508, 201509, 201510, 201511, 201512, 201601)
 ...
 IF OBJECT_ID('reports_bic.dbo.VitasQAregionalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasQAregionalQuestions; 

create table reports_bic.dbo.VitasQAregionalQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.[dbo].[VitasFeedback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[VitasFeedback]; 
  
  CREATE TABLE reports_bic.[dbo].[VitasFeedback](
	[iOID] [int] NOT NULL,
...
IF OBJECT_ID('reports_bic.dbo.VitasQANationalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasQANationalQuestions; 

create table reports_bic.dbo.VitasQANationalQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  smonth varchar(12)
    ...
    IF OBJECT_ID('reports_bic.dbo.VitasQAClientQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasQAClientQuestions; 

create table reports_bic.dbo.VitasQAClientQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.dbo.TempVitasRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempVitasRegional; 

create table  reports_bic.dbo.TempVitasRegional (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
IF OBJECT_ID('reports_bic.dbo.TempVitasClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempVitasClient; 

create table  reports_bic.dbo.TempVitasClient (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
--10 = Hospice Level
--20 = Region Level
--30 = Sub Region Level (Vitas is only one using it)
--40 = Client Level
...
--get Notes
  ...
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.VitasQANationalQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into  reports_bic.dbo.TempVitasRegional
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into  reports_bic.dbo.TempVitasClient
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into reports_bic.[dbo].[VitasFeedback]
...
IF OBJECT_ID('reports_bic.dbo.VitasRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasRegional; 

create table  reports_bic.dbo.VitasRegional (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Vitas Region Level' as info
insert into  reports_bic.dbo.VitasRegional
select ROW_NUMBER() over (order by Provider) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempVitasRegional
--get Notes

declare @regcnt as int,@rgn_step as int,@regionname varchar(100)

select @regcnt=count(*) from reports_bic.dbo.VitasRegional
...
declare @providername varchar(100)
	...
	select @gmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.VitasRegional where seqno=@rgn_step
	select @providername=  Provider from reports_bic.dbo.VitasRegional where seqno=@rgn_step


  select @perQ1 = pQ1 from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ2 = pQ2 from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ4m = pQ4m from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ4x = pQ4x from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ4f = pQ4f from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ5m = pQ5m from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ5x = pQ5x from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ5f = pQ5f from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ6m = pQ6m from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ6x = pQ6x from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ6f = pQ6f from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ7m = pQ7m from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ7x = pQ7x from reports_bic.dbo.VitasRegional where seqno=@rgn_step 
  select @perQ7f = pQ7f from reports_bic.dbo.VitasRegional where seqno=@rgn_step 



  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Equipment',@perQ1,1-@perQ1,null,@gmonth,@providername);
  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Instruction',@perQ2,1-@perQ2,null,@gmonth,@providername);
  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Delivery Person',@perQ4m, @perQ4f, @perQ4x,@gmonth,@providername);
  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Phone Service',@perQ5m, @perQ5f, @perQ5x,@gmonth,@providername);
  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Timely Delivery',@perQ6m, @perQ6f, @perQ6x,@gmonth,@providername);
  insert into reports_bic.dbo.VitasQAregionalQuestions values ('Timely Pickup',@perQ7m, @perQ7f, @perQ7x,@gmonth,@providername);
...
IF OBJECT_ID('reports_bic.dbo.VitasClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasClient; 

create table  reports_bic.dbo.VitasClient (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Vitas Client Level' as info
insert into  reports_bic.dbo.VitasClient
select ROW_NUMBER() over (order by Client) as seqno,iHOS,iRgn, 
	...
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempVitasClient
--get Notes

declare @clientcnt as int,@client_step as int

select @clientcnt=count(*) from reports_bic.dbo.VitasClient
...
declare @clientname varchar(100)
	...
	select @gcmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.VitasClient where seqno=@client_step
	select @cprovidername=  Provider from reports_bic.dbo.VitasClient where seqno=@client_step
	select @clientname= client from reports_bic.dbo.VitasClient where seqno=@client_step


  select @percQ1 = pQ1 from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ2 = pQ2 from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ4m = pQ4m from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ4x = pQ4x from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ4f = pQ4f from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ5m = pQ5m from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ5x = pQ5x from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ5f = pQ5f from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ6m = pQ6m from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ6x = pQ6x from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ6f = pQ6f from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ7m = pQ7m from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ7x = pQ7x from reports_bic.dbo.VitasClient where seqno=@client_step 
  select @percQ7f = pQ7f from reports_bic.dbo.VitasClient where seqno=@client_step 



  insert into reports_bic.dbo.VitasQAClientQuestions values ('Equipment',@percQ1,1-@percQ1,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.VitasQAClientQuestions values ('Instruction',@percQ2,1-@percQ2,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.VitasQAClientQuestions values ('Delivery person',@percQ4m, @percQ4f, @percQ4x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.VitasQAClientQuestions values ('Phone Service',@percQ5m, @percQ5f, @percQ5x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.VitasQAClientQuestions values ('Timely Delivery',@percQ6m, @percQ6f, @percQ6x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.VitasQAClientQuestions values ('Timely Pickup',@percQ7m, @percQ7f, @percQ7x,@gcmonth,@cprovidername,@clientname);
