...
CREATE PROCEDURE dbo.GenerateServiceLevelForTodayOnlyV2
(
	@DebugMode BIT = 0
)
/*
...
(
  ...
  END
	...
	o.iAddressRef, o.iDriverID, o.iOrderedBy, o.CompletionActionId, s.sName As SiteName,r.region as Region,o.Priority,o.ScheduleEnd, RouteId, tz.iTZID, o.LOX,o.isServiceCall,
	case
	...
	delete from reports_bic.dbo.OrderManagementData where dtScheduled between @StartDate and @EndDate
