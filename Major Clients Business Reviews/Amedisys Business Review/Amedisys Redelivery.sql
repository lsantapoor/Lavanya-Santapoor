...
6 -  
*/
 IF OBJECT_ID('reports_bic.[dbo].[AmedisysRedelivery]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[AmedisysRedelivery]; 


CREATE TABLE reports_bic.[dbo].[AmedisysRedelivery](
    smonth [varchar](12),
...
\*-----------------------------------*/
	insert into reports_bic.dbo.AmedisysRedelivery
	select @smonth,d.sName + ', ' + s.sName as Provider, c.sName as Client, --DATENAME(month ,pd.dComplete) as imonth
	...
	group by c.sName, d.sName + ', ' + s.sName
