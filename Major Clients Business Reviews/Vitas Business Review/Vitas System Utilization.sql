...
set @iHOS = 86 --Vitas Innovative Hospice Care (201506, 201507, 201508, 201509, 201510)
...
IF OBJECT_ID('reports_bic.dbo.VitasSystemUtil', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.VitasSystemUtil; 

CREATE TABLE reports_bic.dbo.VitasSystemUtil(
	[sHospice] [varchar](128) NULL,
	[sRegion] [varchar](128) NULL,
	[sClient] [varchar](128) NULL,
	[sProvider] [varchar](128) NULL,
...
insert into reports_bic.dbo.VitasSystemUtil
