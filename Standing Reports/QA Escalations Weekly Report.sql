...
IF OBJECT_ID('reports_bic.dbo.QAWiHOS_list', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.QAWiHOS_list; 

create table reports_bic.dbo.QAWiHOS_list(
iHOS_SEQ_NO int,
iHOS_ID int,
iHOS_name varchar(100)
)

insert into reports_bic.dbo.QAWiHOS_list values(1,87,'Amedisys')
insert into reports_bic.dbo.QAWiHOS_list values(2,29,'Odyssey / Gentiva')
insert into reports_bic.dbo.QAWiHOS_list values(3,10,'Evercare')
insert into reports_bic.dbo.QAWiHOS_list values(4,12,'Alacare')
insert into reports_bic.dbo.QAWiHOS_list values(5,86,'Vitas')
insert into reports_bic.dbo.QAWiHOS_list values(6,299,'Tidewell Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(7,257,'Harbor Light Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(8,238,'SouthernCare, Inc')
insert into reports_bic.dbo.QAWiHOS_list values(9,187,'Santa Cruz')
insert into reports_bic.dbo.QAWiHOS_list values(10,1058,'Elizabeth Hospice, Inc')
insert into reports_bic.dbo.QAWiHOS_list values(11,269,'Suncrest Health Services')
insert into reports_bic.dbo.QAWiHOS_list values(12,1057,'Sta-Home Health & Hospice, Inc.')
insert into reports_bic.dbo.QAWiHOS_list values(13,120,'Banner Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(14,27,'Brookdale Senior Living, Inc')
insert into reports_bic.dbo.QAWiHOS_list values(15,232,'Hospice Partners of America')
insert into reports_bic.dbo.QAWiHOS_list values(16,295,'Encompass Home Health & Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(17,227,'Delaware Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(18,1334,'Cornerstone Hospice & Palliative Care')
insert into reports_bic.dbo.QAWiHOS_list values(19,144,'Signature Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(20,136,'Nathan Adelson Hospice')
insert into reports_bic.dbo.QAWiHOS_list values(21,114,'Montgomery Hospice')
...
select @iHOSNAME=iHOS_name from reports_bic.dbo.QAWiHOS_list where iHOS_SEQ_NO = @iHOS_step 
-----------
