...
/****** Object:  StoredProcedure [dbo].[AdvocateRedeliveryProc]    Script Date: 2/27/2017 9:55:12 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	This is used to pull all the redeliveries for Advocate for a week
-- =============================================
CREATE PROCEDURE [dbo].[AdvocateRedeliveryProc]
...
I. Erickson 20151016 1.8   Fixed issue when no reports.ss.tblClientEquipmentList values existed on equipment lookup.
...
--select @iDME =1639-- @iHOS = null --B&M
--print @iDME
--set @iHOS='336, 1639, 1640'-- Elizabeth Hospice (201602)
...
6 -  
*/
 IF OBJECT_ID('[reports_bic].[dbo].[AdvocateRedelivery]', 'U') IS NOT NULL 
  DROP TABLE [reports_bic].[dbo].[AdvocateRedelivery]; 
CREATE TABLE [reports_bic].[dbo].[AdvocateRedelivery](
    smonth [varchar](12),
...
\*----------------------------------------*/
	IF OBJECT_ID('reports.ss.tblItem_Pairs', 'U') IS NOT NULL 
  DROP TABLE reports.ss.tblItem_Pairs; 
  begin
		CREATE TABLE reports.ss.tblItem_Pairs (
		...
		insert into reports.ss.tblItem_Pairs values (838,195,'') --Bed: Bariatric [ 838 ]
		insert into reports.ss.tblItem_Pairs values (795,195,'') --Bed: Full-Electric (Hospital Grade) [ 795 ]
		insert into reports.ss.tblItem_Pairs values (25,195,'') --Bed: Full-Electric [ 25 ]
		insert into reports.ss.tblItem_Pairs values (9,195,'') --Bed - Semi-Electric [ 9 ]

		--WC - Foot Rests (pair) [ 313 ] ( Paired with Wheelchairs )
		insert into reports.ss.tblItem_Pairs values (322,313,'') --Wheelchair Heavy Duty 20 [ 322 ]
		insert into reports.ss.tblItem_Pairs values (323,313,'') --Wheelchair Heavy Duty 22 [ 323 ]
		insert into reports.ss.tblItem_Pairs values (324,313,'') --Wheelchair Heavy Duty 24 [ 324 ]
		insert into reports.ss.tblItem_Pairs values (783,313,'') --Wheelchair Heavy Duty 28 [ 783 ]
		insert into reports.ss.tblItem_Pairs values (893,313,'') --Wheelchair Hemi 16" [ 893 ]
		insert into reports.ss.tblItem_Pairs values (894,313,'') --Wheelchair Hemi 18" [ 894 ]
		insert into reports.ss.tblItem_Pairs values (895,313,'') --Wheelchair Hemi 20" [ 895 ]
		insert into reports.ss.tblItem_Pairs values (329,313,'') --Wheelchair Lightweight 14" [ 329 ]
		insert into reports.ss.tblItem_Pairs values (330,313,'') --Wheelchair Lightweight 16" [ 330 ]
		insert into reports.ss.tblItem_Pairs values (331,313,'') --Wheelchair Lightweight 18" [ 331 ]
		insert into reports.ss.tblItem_Pairs values (332,313,'') --Wheelchair Lightweight 20" [ 332 ]
		insert into reports.ss.tblItem_Pairs values (333,313,'') --Wheelchair Lightweight 22" [ 333 ]
		insert into reports.ss.tblItem_Pairs values (334,313,'') --Wheelchair Lightweight 24" [ 334 ]
		insert into reports.ss.tblItem_Pairs values (697,313,'') --Solara Tilt in Space 16" [ 697 ]
		insert into reports.ss.tblItem_Pairs values (698,313,'') --Solara Tilt in Space 18" [ 698 ]
		insert into reports.ss.tblItem_Pairs values (699,313,'') --Solara Tilt in Space 20" [ 699 ]
		insert into reports.ss.tblItem_Pairs values (700,313,'') --Solara Tilt in Space 22" [ 700 ]
		insert into reports.ss.tblItem_Pairs values (790,313,'') --Tilt & Reclining WC 18" [ 790 ]
		insert into reports.ss.tblItem_Pairs values (325,313,'') --Wheelchair High Back Recliner 16" [ 325 ]
		insert into reports.ss.tblItem_Pairs values (326,313,'') --Wheelchair High Back Recliner 18" [ 326 ]
		insert into reports.ss.tblItem_Pairs values (327,313,'') --Wheelchair High Back Recliner 20" [ 327 ]
		insert into reports.ss.tblItem_Pairs values (328,313,'') --Wheelchair High Back Recliner 22" [ 328 ]
		insert into reports.ss.tblItem_Pairs values (896,313,'') --Wheelchair High Back Recliner 24" [ 896 ]
		insert into reports.ss.tblItem_Pairs values (775,313,'') --Wheelchair Lightweight Recliner 18" [ 775 ]
		insert into reports.ss.tblItem_Pairs values (793,313,'') --Wheelchair Companion 14" [ 793 ]
		insert into reports.ss.tblItem_Pairs values (335,313,'') --Wheelchair Pediatric 18" [ 335 ]
		insert into reports.ss.tblItem_Pairs values (792,313,'') --Wheelchair Standard 14" [ 792 ]
		insert into reports.ss.tblItem_Pairs values (336,313,'') --Wheelchair Standard 16" [ 336 ]
		insert into reports.ss.tblItem_Pairs values (337,313,'') --Wheelchair Standard 18" [ 337 ]
		insert into reports.ss.tblItem_Pairs values (338,313,'') --Wheelchair Standard 20" [ 338 ]
		insert into reports.ss.tblItem_Pairs values (339,313,'') --Wheelchair Standard 22" [ 339 ]
		insert into reports.ss.tblItem_Pairs values (340,313,'') --Wheelchair Standard 24" [ 340 ]
		insert into reports.ss.tblItem_Pairs values (746,313,'') --Wheelchair Standard 26" [ 746 ]
		insert into reports.ss.tblItem_Pairs values (847,313,'') --Wheelchair Standard 28" [ 847 ]
		insert into reports.ss.tblItem_Pairs values (848,313,'') --Wheelchair Standard 30" [ 848 ]
		insert into reports.ss.tblItem_Pairs values (320,313,'') --Wheelchair Companion 16" [ 320 ]
		insert into reports.ss.tblItem_Pairs values (321,313,'') --Wheelchair Companion 18" [ 321 ]
		insert into reports.ss.tblItem_Pairs values (791,313,'') --Wheelchair companion 19" [ 791 ]
		insert into reports.ss.tblItem_Pairs values (695,313,'') --Wheelchair companion 20" [ 695 ]
		insert into reports.ss.tblItem_Pairs values (696,313,'') --Wheelchair companion 22" [ 696 ]
		
		--WC - Elevated Leg Rest (pair) [ 312 ] ( Paired with Wheelchairs )
		insert into reports.ss.tblItem_Pairs values (322,312,'') --Wheelchair Heavy Duty 20 [ 322 ]
		insert into reports.ss.tblItem_Pairs values (323,312,'') --Wheelchair Heavy Duty 22 [ 323 ]
		insert into reports.ss.tblItem_Pairs values (324,312,'') --Wheelchair Heavy Duty 24 [ 324 ]
		insert into reports.ss.tblItem_Pairs values (783,312,'') --Wheelchair Heavy Duty 28 [ 783 ]
		insert into reports.ss.tblItem_Pairs values (893,312,'') --Wheelchair Hemi 16" [ 893 ]
		insert into reports.ss.tblItem_Pairs values (894,312,'') --Wheelchair Hemi 18" [ 894 ]
		insert into reports.ss.tblItem_Pairs values (895,312,'') --Wheelchair Hemi 20" [ 895 ]
		insert into reports.ss.tblItem_Pairs values (329,312,'') --Wheelchair Lightweight 14" [ 329 ]
		insert into reports.ss.tblItem_Pairs values (330,312,'') --Wheelchair Lightweight 16" [ 330 ]
		insert into reports.ss.tblItem_Pairs values (331,312,'') --Wheelchair Lightweight 18" [ 331 ]
		insert into reports.ss.tblItem_Pairs values (332,312,'') --Wheelchair Lightweight 20" [ 332 ]
		insert into reports.ss.tblItem_Pairs values (333,312,'') --Wheelchair Lightweight 22" [ 333 ]
		insert into reports.ss.tblItem_Pairs values (334,312,'') --Wheelchair Lightweight 24" [ 334 ]
		insert into reports.ss.tblItem_Pairs values (697,312,'') --Solara Tilt in Space 16" [ 697 ]
		insert into reports.ss.tblItem_Pairs values (698,312,'') --Solara Tilt in Space 18" [ 698 ]
		insert into reports.ss.tblItem_Pairs values (699,312,'') --Solara Tilt in Space 20" [ 699 ]
		insert into reports.ss.tblItem_Pairs values (700,312,'') --Solara Tilt in Space 22" [ 700 ]
		insert into reports.ss.tblItem_Pairs values (790,312,'') --Tilt & Reclining WC 18" [ 790 ]
		insert into reports.ss.tblItem_Pairs values (325,312,'') --Wheelchair High Back Recliner 16" [ 325 ]
		insert into reports.ss.tblItem_Pairs values (326,312,'') --Wheelchair High Back Recliner 18" [ 326 ]
		insert into reports.ss.tblItem_Pairs values (327,312,'') --Wheelchair High Back Recliner 20" [ 327 ]
		insert into reports.ss.tblItem_Pairs values (328,312,'') --Wheelchair High Back Recliner 22" [ 328 ]
		insert into reports.ss.tblItem_Pairs values (896,312,'') --Wheelchair High Back Recliner 24" [ 896 ]
		insert into reports.ss.tblItem_Pairs values (775,312,'') --Wheelchair Lightweight Recliner 18" [ 775 ]
		insert into reports.ss.tblItem_Pairs values (793,312,'') --Wheelchair Companion 14" [ 793 ]
		insert into reports.ss.tblItem_Pairs values (335,312,'') --Wheelchair Pediatric 18" [ 335 ]
		insert into reports.ss.tblItem_Pairs values (792,312,'') --Wheelchair Standard 14" [ 792 ]
		insert into reports.ss.tblItem_Pairs values (336,312,'') --Wheelchair Standard 16" [ 336 ]
		insert into reports.ss.tblItem_Pairs values (337,312,'') --Wheelchair Standard 18" [ 337 ]
		insert into reports.ss.tblItem_Pairs values (338,312,'') --Wheelchair Standard 20" [ 338 ]
		insert into reports.ss.tblItem_Pairs values (339,312,'') --Wheelchair Standard 22" [ 339 ]
		insert into reports.ss.tblItem_Pairs values (340,312,'') --Wheelchair Standard 24" [ 340 ]
		insert into reports.ss.tblItem_Pairs values (746,312,'') --Wheelchair Standard 26" [ 746 ]
		insert into reports.ss.tblItem_Pairs values (847,312,'') --Wheelchair Standard 28" [ 847 ]
		insert into reports.ss.tblItem_Pairs values (848,312,'') --Wheelchair Standard 30" [ 848 ]
		insert into reports.ss.tblItem_Pairs values (320,312,'') --Wheelchair Companion 16" [ 320 ]
		insert into reports.ss.tblItem_Pairs values (321,312,'') --Wheelchair Companion 18" [ 321 ]
		insert into reports.ss.tblItem_Pairs values (791,312,'') --Wheelchair companion 19" [ 791 ]
		insert into reports.ss.tblItem_Pairs values (695,312,'') --Wheelchair companion 20" [ 695 ]
		insert into reports.ss.tblItem_Pairs values (696,312,'') --Wheelchair companion 22" [ 696 ]

		--Sling: Canvas (Hole) [ 236 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,236,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,236,'') --Hoyer Lift [ 128 ]

		--Sling: Canvas [ 235 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,235,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,235,'') --Hoyer Lift [ 128 ]

		--Sling: Divided Leg [ 237 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,237,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,237,'') --Hoyer Lift [ 128 ]

		--Sling: Mesh (Hole) [ 239 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,239,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,239,'') --Hoyer Lift [ 128 ]

		--Sling: Mesh [ 238 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,238,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,238,'') --Hoyer Lift [ 128 ]

		--Sling: Nylon [ 240 ] ( Paired with Lifts )
		insert into reports.ss.tblItem_Pairs values (342,240,'') --Electric Patient Lift [ 342 ]
		insert into reports.ss.tblItem_Pairs values (128,240,'') --Hoyer Lift [ 128 ]

		--Mask: Full Face [ 150 ] ( Paired with BiPAP / CPAP )
		insert into reports.ss.tblItem_Pairs values (28,150,'') --BiPAP ST Unit (Humidifier) [ 28 ]
		insert into reports.ss.tblItem_Pairs values (27,150,'') --BiPAP ST Unit [ 27 ]
		insert into reports.ss.tblItem_Pairs values (30,150,'') --BiPAP Unit (Humidifier) [ 30 ]
		insert into reports.ss.tblItem_Pairs values (29,150,'') --BiPAP Unit [ 29 ]
		insert into reports.ss.tblItem_Pairs values (55,150,'') --CPAP Unit [ 55 ]

		--O2 Backup Cart [ 175 ] ( Paired with Cylinders )
		insert into reports.ss.tblItem_Pairs values (187,175,'') --O2: E Cylinder [ 187 ]

		--O2 Rack (12 bay) [ 183 ] ( Paired with Cylinders )
		insert into reports.ss.tblItem_Pairs values (187,183,'') --O2: E Cylinder [ 187 ]
		insert into reports.ss.tblItem_Pairs values (189,183,'') --O2: M-6 Cylinder [ 189 ]

		--O2 Rack (6 bay) [ 184 ] ( Paired with Cylinders )
		insert into reports.ss.tblItem_Pairs values (187,184,'') --O2: E Cylinder [ 187 ]
		insert into reports.ss.tblItem_Pairs values (189,184,'') --O2: M-6 Cylinder [ 189 ]

		--Commode: Bariatric [ 825 ] ( Paired with Beds )
		insert into reports.ss.tblItem_Pairs values (838,825,'') --Bed: Bariatric [ 838 ]
		insert into reports.ss.tblItem_Pairs values (795,825,'') --Bed: Full-Electric (Hospital Grade) [ 795 ]
		insert into reports.ss.tblItem_Pairs values (25,825,'') --Bed: Full-Electric [ 25 ]
		insert into reports.ss.tblItem_Pairs values (9,825,'') --Bed - Semi-Electric [ 9 ]
		
		--Commode: Bedside [ 47 ] ( Paired with Beds )
		insert into reports.ss.tblItem_Pairs values (838,47,'') --Bed: Bariatric [ 838 ]
		insert into reports.ss.tblItem_Pairs values (795,47,'') --Bed: Full-Electric (Hospital Grade) [ 795 ]
		insert into reports.ss.tblItem_Pairs values (25,47,'') --Bed: Full-Electric [ 25 ]
		insert into reports.ss.tblItem_Pairs values (9,47,'') --Bed - Semi-Electric [ 9 ]
		
		--Commode: Extra Wide [ 49 ] ( Paired with Beds )
		insert into reports.ss.tblItem_Pairs values (838,49,'') --Bed: Bariatric [ 838 ]
		insert into reports.ss.tblItem_Pairs values (795,49,'') --Bed: Full-Electric (Hospital Grade) [ 795 ]
		insert into reports.ss.tblItem_Pairs values (25,49,'') --Bed: Full-Electric [ 25 ]
		insert into reports.ss.tblItem_Pairs values (9,49,'') --Bed - Semi-Electric [ 9 ]

		--Small Volume Nebulizer [ 241 ] ( Paired with Concentrator )
		insert into reports.ss.tblItem_Pairs values (50,241,'') --Concentrator 05 L [ 50 ]

		--Suction Machine (Continuous) [ 250 ] ( Paired with Concentrator )
		insert into reports.ss.tblItem_Pairs values (50,250,'') --Concentrator 05 L [ 50 ]

		--Suction Machine (Intermittent) [ 251 ] ( Paired with Concentrator )
		insert into reports.ss.tblItem_Pairs values (50,251,'') --Concentrator 05 L [ 50 ]

		update reports.ss.tblItem_Pairs
		set sDescription = '[ ' + ltrim(rtrim(si.sName)) + ' ] paired with [ ' + ltrim(rtrim(mi.sName)) + ' ]'
		from reports.ss.tblItem_Pairs as pair
		left join reports.ss.tblItem as mi on mi.iItemID = pair.iIID_Main
		left join reports.ss.tblItem as si on si.iItemID = pair.iIID_Sub

		--select * from reports.ss.tblItem_Pairs
	End
/*----------------------------------------*\
...
----------------------------------------*/
	...
	--drop table reports.ss.tblUSState --< in case we need to kill it...
	if not exists (select * from dbo.sysobjects where id = object_id(N'[ss].[tblUSState]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
	begin
		--Create New Temp Table
		CREATE TABLE reports.ss.tblUSState (
			iRGN int,
			sState char(2),
			sRegion char(10)
		)  ON [PRIMARY]

		insert into reports.ss.tblUSState  values (-1,'DE','DE: Region')
		insert into reports.ss.tblUSState  values (-2,'NJ','NJ: Region')
		insert into reports.ss.tblUSState  values (-3,'PA','PA: Region')
		insert into reports.ss.tblUSState  values (-4,'GA','GA: Region')
		insert into reports.ss.tblUSState  values (-5,'CT','CT: Region')
		insert into reports.ss.tblUSState  values (-6,'MA','MA: Region')
		insert into reports.ss.tblUSState  values (-7,'MD','MD: Region')
		insert into reports.ss.tblUSState  values (-8,'SC','SC: Region')
		insert into reports.ss.tblUSState  values (-9,'NH','NH: Region')
		insert into reports.ss.tblUSState  values (-10,'VA','VA: Region')
		insert into reports.ss.tblUSState  values (-11,'NY','NY: Region')
		insert into reports.ss.tblUSState  values (-12,'NC','NC: Region')
		insert into reports.ss.tblUSState  values (-13,'RI','RI: Region')
		insert into reports.ss.tblUSState  values (-14,'VT','VT: Region')
		insert into reports.ss.tblUSState  values (-15,'KY','KY: Region')
		insert into reports.ss.tblUSState  values (-16,'TN','TN: Region')
		insert into reports.ss.tblUSState  values (-17,'OH','OH: Region')
		insert into reports.ss.tblUSState  values (-18,'LA','LA: Region')
		insert into reports.ss.tblUSState  values (-19,'IN','IN: Region')
		insert into reports.ss.tblUSState  values (-20,'MS','MS: Region')
		insert into reports.ss.tblUSState  values (-21,'IL','IL: Region')
		insert into reports.ss.tblUSState  values (-22,'AL','AL: Region')
		insert into reports.ss.tblUSState  values (-23,'ME','ME: Region')
		insert into reports.ss.tblUSState  values (-24,'MO','MO: Region')
		insert into reports.ss.tblUSState  values (-25,'AR','AR: Region')
		insert into reports.ss.tblUSState  values (-26,'MI','MI: Region')
		insert into reports.ss.tblUSState  values (-27,'FL','FL: Region')
		insert into reports.ss.tblUSState  values (-28,'TX','TX: Region')
		insert into reports.ss.tblUSState  values (-29,'IA','IA: Region')
		insert into reports.ss.tblUSState  values (-30,'WI','WI: Region')
		insert into reports.ss.tblUSState  values (-31,'CA','CA: Region')
		insert into reports.ss.tblUSState  values (-32,'MN','MN: Region')
		insert into reports.ss.tblUSState  values (-33,'OR','OR: Region')
		insert into reports.ss.tblUSState  values (-34,'KS','KS: Region')
		insert into reports.ss.tblUSState  values (-35,'WV','WV: Region')
		insert into reports.ss.tblUSState  values (-36,'NV','NV: Region')
		insert into reports.ss.tblUSState  values (-37,'NE','NE: Region')
		insert into reports.ss.tblUSState  values (-38,'CO','CO: Region')
		insert into reports.ss.tblUSState  values (-39,'ND','ND: Region')
		insert into reports.ss.tblUSState  values (-40,'SD','SD: Region')
		insert into reports.ss.tblUSState  values (-41,'MT','MT: Region')
		insert into reports.ss.tblUSState  values (-42,'WA','WA: Region')
		insert into reports.ss.tblUSState  values (-43,'ID','ID: Region')
		insert into reports.ss.tblUSState  values (-44,'WY','WY: Region')
		insert into reports.ss.tblUSState  values (-45,'UT','UT: Region')
		insert into reports.ss.tblUSState  values (-46,'OK','OK: Region')
		insert into reports.ss.tblUSState  values (-47,'NM','NM: Region')
		insert into reports.ss.tblUSState  values (-48,'AZ','AZ: Region')
		insert into reports.ss.tblUSState  values (-49,'AK','AK: Region')
		insert into reports.ss.tblUSState  values (-50,'HI','HI: Region')
		insert into reports.ss.tblUSState  values (-51,'DC','DC: Region')
	End
	...
	from reports.ss.tblBudget as bu
	join (
		select iLocationID as iSID from reports.ss.tblLocation where iCompanyRef = isnull(@iDME,iCompanyRef) and cType = 'S'
	) as s on s.iSID = bu.iSiteRef
	join (
		select iLocationID as iCID from reports.ss.tblLocation where iCompanyRef = isnull(@iHOS,iCompanyRef) and cType = 'C'
	...
	where iDMEID in (336,1640,1639) and iPatientID in (
		select iPatientID from reports.ss.tblPatient as p
...
if @iDebugStep_Bgn >= 1 begin
	...
	join reports.ss.tblPatient as p on p.iPatientID = rd.iPID 
	...
	update @tmpRpt_Redelivery_Pre set
		iCntPickup = (isnull((
			select SUM(1) as iCnt from reports.ss.tblOrderDetail where iReferenceOrderID = iOID
		),0))
	...
	update @tmpRpt_Redelivery_Pre set
		iCntDisp = (isnull((
			select SUM(1) as iCnt from reports.ss.tblOrderDetail as od
			join reports.ss.tblProductEquip as pe on pe.iProductRef = od.iProductID
			join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
			left join reports.ss.setClientEquipList as ce on ce.iEquipmentRef = pe.iEquipmentRef and ce.iClientRef = iCID and ce.iSiteRef = iSID
			where iOrderID = iOID
	...
	if @iDebugStep_Bgn >= 4 begin
		if @iDebugStep_End <= 4 begin
			if isnull(@iOID_Debug,0) <> 0 begin
				...
				from reports.ss.tblOrderDetail as od
				join reports.ss.tblOrder as o on o.iOrderID = od.iOrderID
				join reports.ss.tblPatient as p on p.iPatientID = o.iPatientID
				join reports.ss.tblProductEquip as pe on pe.iProductRef = od.iProductID
				join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
				join reports.ss.tblItem as i on i.IItemID = e.iItemRef
				left join reports.ss.setClientEquipList as ce on ce.iEquipmentRef = pe.iEquipmentRef and ce.iClientRef = p.iClientRef and ce.iSiteRef = p.iSiteRef
				where od.iOrderID = @iOID_Debug
				or od.iReferenceOrderID = @iOID_Debug
			end
			select iOrderID, iItemRef, sum(1) as xCnt from reports.ss.tblOrderDetail as od 
			join reports.ss.tblProductEquip as pe on pe.iProductRef = od.iProductID
			join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
	...
	update @tmpRpt_Redelivery_Pre set
		iCntPaired = (isnull((
			select SUM(1) as iCnt from reports.ss.tblOrderDetail 
			where iProductID in (
				select iProductRef from reports.ss.tblProductEquip where iEquipmentRef in (
					select iEquipmentID from reports.ss.tblEquipment 
					where iItemRef in (
						select distinct iIID_Sub from reports.ss.tblItem_Pairs
					)
					and iCompanyRef in (
						select distinct iCompanyRef from reports.ss.tblLocation where iLocationID in (
	...
	-- Paired = number of paired items from reports.ss.tblItem_Paired that are in this order
	...
	if @iDebug = 1 begin
		if @iOID_Debug is not null begin
			...
			select szProductName, od.* from reports.ss.tblOrderDetail as od join reports.ss.tblProduct as pr on pr.iProductID = od.iProductID where iOrderID = @iOID_Debug
		end
		if isnull(@iPID_Debug,0) <> 0 begin
	...
	set iRedeliveryProductCnt = (
		select isnull(SUM(1),0) as xCnt from reports.ss.tblOrderDetail where iOrderID = p.iOID and iProductID = 25400
	)
	from @tmpRpt_Redelivery_Pre as p
	...
	from @Orders as o 
	join reports.ss.tblOrderNotepad as onp on onp.iOrderRef = o.iOID
	...
	BEGIN
		...
		from reports.ss.tblOrderDetail as od
		join reports.ss.tblProductEquip as pe on od.iProductID = pe.iProductRef
		join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
		join reports.ss.tblStatus as s on s.cStatusID = od.cStatusID
...
left join reports.ss.tblOrderDetail as od on od.iOrderID = r.iOID
left join reports.ss.tblProductEquip as pe on pe.iProductRef = od.iProductID
left join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
left join reports.ss.tblOrder as o on o.iOrderID = r.iOID
where r.sFlagPaired = '!'
and e.iItemRef in (
	select distinct iIID_Sub from reports.ss.tblItem_Pairs
)
...
OPEN cu_Paired
	...
	BEGIN
		...
		left join reports.ss.tblProductEquip as pe on pe.iProductRef = od.iProductID
		left join reports.ss.tblEquipment as e on e.iEquipmentID = pe.iEquipmentRef
		left join reports.ss.tblOrder as o on o.iOrderID = od.iOrderID
		where od.iOrderID in (select iOID from dbo.tmp_PairedOrders where cType = 'S')					--On an Order for this Stop
		and e.iItemRef in (select distinct iIID_Main from reports.ss.tblItem_Pairs where iIID_Sub = @z_iIIDs)	--A Main Item for this Sub Item
...
\*-----------------------------------*/
	insert into [reports_bic].[dbo].[AdvocateRedelivery]
	...
	join reports.ss.tblPatient as p on p.iPatientID = pd.iPID 
	join reports.ss.tblLocation as s on s.iLocationID = p.iSiteRef 
	join reports.ss.tblCompany as d on s.iCompanyRef = d.iCompanyID 
	join reports.ss.tblLocation as c on c.iLocationID = p.iClientRef 
	left join reports.ss.tblSet as re on re.iSetId = c.iSetRef
	where pd.dComplete >= @dS and pd.dComplete <= @dE
