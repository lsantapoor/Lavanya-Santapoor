...
set @iHOS = 1058-- Elizabeth Hospice (201602)

IF OBJECT_ID('reports_bic.dbo.ElizabethQAQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.ElizabethQAQuestions; 

create table reports_bic.dbo.ElizabethQAQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.[dbo].[ElizabethFeedback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[ElizabethFeedback]; 
  
  CREATE TABLE reports_bic.[dbo].[ElizabethFeedback](
	[iOID] [int] NOT NULL,
...
--get Notes
  ...
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.ElizabethQAQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into reports_bic.[dbo].[ElizabethFeedback]
