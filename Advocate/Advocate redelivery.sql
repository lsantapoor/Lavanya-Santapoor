...
set @iHOS = 1640 -- Cornerstone Hospice & Palliative Care (201601)
...
CREATE TABLE reports_bic.[dbo].[AdvocateRedelivery](
	...
	[Region Name] [varchar](64) Null,
	[Orders] [int] NULL,
	[Redelivery] [int] NULL,
	[Missed Pair] [int] NULL,
...
Create TABLE dbo.tmp_Paired (
 ...
 IF OBJECT_ID('[dbo].[tmp_PairedOrders]', 'U') IS NOT NULL 
...
Set @query = 'select * from reports_bic.dbo.AdvocateRedelivery';
print @query
Declare @sub varchar(max)
set @sub= 'Advocate Redelivery Report'+ N' ' + N'- ' + CONVERT(VARCHAR(12),@dS,101)
print @sub
Execute msdb.dbo.sp_send_dbmail
	 ...
	 @subject = @sub
	  ...
	  Please find the weekly redelivery report attached.
      ...
      , @query_attachment_filename = 'Advocate Redelivery.csv'
