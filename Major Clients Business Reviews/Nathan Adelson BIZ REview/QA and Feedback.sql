...
IF OBJECT_ID('reports_bic.dbo.nathanQAQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.nathanQAQuestions; 

create table reports_bic.dbo.nathanQAQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.[dbo].[NathanFeeback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[NathanFeeback]; 
  
  CREATE TABLE reports_bic.[dbo].[NathanFeeback](
	[iOID] [int] NOT NULL,
...
--get Notes
  ...
  insert into reports_bic.dbo.nathanQAQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.nathanQAQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.nathanQAQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.nathanQAQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.nathanQAQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.nathanQAQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into reports_bic.[dbo].[NathanFeeback]
