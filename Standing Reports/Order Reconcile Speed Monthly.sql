...
IF OBJECT_ID('reports_bic.dbo.OrderReconcileSpeedMonthly ', 'U') IS NOT NULL 
  DROP TABLE  reports_bic.dbo.OrderReconcileSpeedMonthly ; 
...
Create table reports_bic.dbo.OrderReconcileSpeedMonthly 
(
...
insert into reports_bic.dbo.OrderReconcileSpeedMonthly 
SELECT	
	...
	--update timespans
	update	reports_bic.dbo.OrderReconcileSpeedMonthly 
	...
	select * from reports_bic.dbo.OrderReconcileSpeedMonthly 
...
-- Below code is to send data by email to the recipients--
 ...
 Declare @query nvarchar(max);
    Set @query = 'select * from reports_bic.dbo.OrderReconcileSpeedMonthly';
 ...
 Execute msdb.dbo.sp_send_dbmail
	 ...
	 ,@copy_recipients = 'lsantapoor@stateserv.com'
      , @subject = 'Order Reconcile Speed Monthly'
      , @body = 'Hi,
	  
	  Please find the monthly Order Reconcile Speed Report attached.
      ...
      , @query_attachment_filename = 'Order Reconcile Speed Monthly.csv'
