...
6 -  
*/
 IF OBJECT_ID('reports_bic.[dbo].[CornerstoneRedelivery]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[CornerstoneRedelivery]; 


CREATE TABLE reports_bic.[dbo].[CornerstoneRedelivery](
    smonth [varchar](12),
...
\*-----------------------------------*/
	insert into reports_bic.dbo.CornerstoneRedelivery
