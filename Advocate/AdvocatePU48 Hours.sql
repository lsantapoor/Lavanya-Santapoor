...
insert into reports_bic.[dbo].[AdvocatePUTimeframe]
SELECT	o.iOrderID,
		o.iPatientID,
		o.iDMEID,
		o.cStatusID,
...
--o.iReferenceOrderID,
 ...
 Declare @query nvarchar(max);
    Set @query = 'select * from reports_bic.[dbo].[AdvocatePUTimeframe]';
 ...
 Execute msdb.dbo.sp_send_dbmail
	 ...
	 ,@copy_recipients = 'lsantapoor@stateserv.com'
      , @subject = 'Advocate Pickups within 48 Hours'
      , @body = 'Hi,
      ...
      , @query_attachment_filename = 'Pickups within 48 Hours Monthly.csv'
