...
6 -  
*/
 IF OBJECT_ID('reports_bic.[dbo].[ElizabethRedelivery]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[ElizabethRedelivery]; 


CREATE TABLE reports_bic.[dbo].[ElizabethRedelivery](
    smonth [varchar](12),
...
\*-----------------------------------*/
	insert into reports_bic.dbo.ElizabethRedelivery
