...
set @iHOS = 1334 -- Cornerstone Hospice & Palliative Care (201601)
 ...
 IF OBJECT_ID('reports_bic.dbo.CornerstoneQAregionalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.CornerstoneQAregionalQuestions; 

create table reports_bic.dbo.CornerstoneQAregionalQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.[dbo].[CornerstoneFeedback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[CornerstoneFeedback]; 
  
  CREATE TABLE reports_bic.[dbo].[CornerstoneFeedback](
	[iOID] [int] NOT NULL,
...
IF OBJECT_ID('reports_bic.dbo.CornerstoneQANationalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.CornerstoneQANationalQuestions; 

create table reports_bic.dbo.CornerstoneQANationalQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  smonth varchar(12)
    ...
    IF OBJECT_ID('reports_bic.dbo.CornerStoneQAClientQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.CornerStoneQAClientQuestions; 

create table reports_bic.dbo.CornerStoneQAClientQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.dbo.TempCornerstoneRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempCornerstoneRegional; 

create table  reports_bic.dbo.TempCornerstoneRegional (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
IF OBJECT_ID('reports_bic.dbo.TempCornerStoneClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempCornerStoneClient; 

create table  reports_bic.dbo.TempCornerStoneClient (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
--10 = Hospice Level
--20 = Region Level
--30 = Sub Region Level (Cornerstone is only one using it)
--40 = Client Level
...
--get Notes
  ...
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.CornerstoneQANationalQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into  reports_bic.dbo.TempCornerstoneRegional
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into  reports_bic.dbo.TempCornerStoneClient
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into reports_bic.[dbo].[CornerstoneFeedback]
...
IF OBJECT_ID('reports_bic.dbo.CornerstoneRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.CornerstoneRegional; 

create table  reports_bic.dbo.CornerstoneRegional (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Cornerstone Region Level' as info
insert into  reports_bic.dbo.CornerstoneRegional
select ROW_NUMBER() over (order by Provider) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempCornerstoneRegional
--get Notes

declare @regcnt as int,@rgn_step as int,@regionname char(100)

select @regcnt=count(*) from reports_bic.dbo.CornerstoneRegional
...
declare @providername varchar(100)
	...
	select @gmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step
	select @providername=  Provider from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step


  select @perQ1 = pQ1 from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ2 = pQ2 from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ4m = pQ4m from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ4x = pQ4x from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ4f = pQ4f from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ5m = pQ5m from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ5x = pQ5x from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ5f = pQ5f from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ6m = pQ6m from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ6x = pQ6x from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ6f = pQ6f from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ7m = pQ7m from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ7x = pQ7x from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 
  select @perQ7f = pQ7f from reports_bic.dbo.CornerstoneRegional where seqno=@rgn_step 



  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Equipment',@perQ1,1-@perQ1,null,@gmonth,@providername);
  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Instruction',@perQ2,1-@perQ2,null,@gmonth,@providername);
  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Delivery Person',@perQ4m, @perQ4f, @perQ4x,@gmonth,@providername);
  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Phone Service',@perQ5m, @perQ5f, @perQ5x,@gmonth,@providername);
  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Timely Delivery',@perQ6m, @perQ6f, @perQ6x,@gmonth,@providername);
  insert into reports_bic.dbo.CornerstoneQAregionalQuestions values ('Timely Pickup',@perQ7m, @perQ7f, @perQ7x,@gmonth,@providername);
...
IF OBJECT_ID('reports_bic.dbo.CornerStoneClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.CornerStoneClient; 

create table  reports_bic.dbo.CornerStoneClient (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
--Client Levl transpose--

select 'CornerStone Client Level' as info
insert into  reports_bic.dbo.CornerStoneClient
select ROW_NUMBER() over (order by Client) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempCornerStoneClient
--get Notes

declare @clientcnt as int,@client_step as int

select @clientcnt=count(*) from reports_bic.dbo.CornerStoneClient
...
declare @clientname varchar(100)
	...
	select @gcmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.CornerStoneClient where seqno=@client_step
	select @cprovidername=  Provider from reports_bic.dbo.CornerStoneClient where seqno=@client_step
	select @clientname= client from reports_bic.dbo.CornerStoneClient where seqno=@client_step


  select @percQ1 = pQ1 from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ2 = pQ2 from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ4m = pQ4m from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ4x = pQ4x from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ4f = pQ4f from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ5m = pQ5m from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ5x = pQ5x from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ5f = pQ5f from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ6m = pQ6m from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ6x = pQ6x from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ6f = pQ6f from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ7m = pQ7m from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ7x = pQ7x from reports_bic.dbo.CornerStoneClient where seqno=@client_step 
  select @percQ7f = pQ7f from reports_bic.dbo.CornerStoneClient where seqno=@client_step 



  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Equipment',@percQ1,1-@percQ1,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Instruction',@percQ2,1-@percQ2,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Delivery person',@percQ4m, @percQ4f, @percQ4x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Phone Service',@percQ5m, @percQ5f, @percQ5x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Timely Delivery',@percQ6m, @percQ6f, @percQ6x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.CornerStoneQAClientQuestions values ('Timely Pickup',@percQ7m, @percQ7f, @percQ7x,@gcmonth,@cprovidername,@clientname);
