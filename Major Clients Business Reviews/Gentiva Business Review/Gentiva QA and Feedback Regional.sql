...
set @iHOS = 29 --Odyssey / Gentiva (201310,201401)
 ...
 IF OBJECT_ID('reports_bic.dbo.GentivaQAregionalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.GentivaQAregionalQuestions; 

create table reports_bic.dbo.GentivaQAregionalQuestions
( Question varchar(50) Not null,
  ...
  IF OBJECT_ID('reports_bic.dbo.GentivaQAClientQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.GentivaQAClientQuestions; 

create table reports_bic.dbo.GentivaQAClientQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.[dbo].[GentivaFeedback]', 'U') IS NOT NULL 
  DROP TABLE reports_bic.[dbo].[GentivaFeedback]; 
  
  CREATE TABLE reports_bic.[dbo].[GentivaFeedback](
	[iOID] [int] NOT NULL,
...
IF OBJECT_ID('reports_bic.dbo.GentivaQANationalQuestions', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.GentivaQANationalQuestions; 

create table reports_bic.dbo.GentivaQANationalQuestions
( Question varchar(50) Not null,
  meet numeric(9,6) NULL,
  fail numeric(9,6),
  exceed numeric(9,6),
  ...
  IF OBJECT_ID('reports_bic.dbo.TempGentivaRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempGentivaRegional; 

create table  reports_bic.dbo.TempGentivaRegional (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
IF OBJECT_ID('reports_bic.dbo.TempGentivaClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.TempGentivaClient; 

create table  reports_bic.dbo.TempGentivaClient (
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
	[iNoCnt] [int] NULL,
...
--10 = Hospice Level
--20 = Region Level
--30 = Sub Region Level (Gentiva is only one using it)
--40 = Client Level
...
--get Notes
  ...
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Equipment',@pq1,1-@pq1,null,@smonth);
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Instruction',@pq2,1-@pq2,null,@smonth);
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Delivery Person',@pQ4m, @pQ4f, @pQ4x,@smonth);
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Phone Service',@pQ5m, @pQ5f, @pQ5x,@smonth);
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Timely Delivery',@pQ6m, @pQ6f, @pQ6x,@smonth);
  insert into reports_bic.dbo.GentivaQANationalQuestions values ('Timely Pickup',@pQ7m, @pQ7f, @pQ7x,@smonth);
...
insert into  reports_bic.dbo.TempGentivaRegional
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into  reports_bic.dbo.TempGentivaClient
select iHC_ID as iHOS, iSR_ID as iRgn, 
	iTotal, iNoCnt, iOpOut, iNoEng, iAbort, iUsable, iDone,
	xQ1, iQ1y, iQ1n, pQ1,
	xQ2, iQ2y, iQ2n, pQ2,
...
insert into reports_bic.[dbo].[GentivaFeedback]
select QAR.iOrderRef as iOID, --QAF.cType, 
	...
	rtrim(isnull(re.sName,c.sState + ' Region')), rtrim(ltrim(c.sName)) as ClientName
...
IF OBJECT_ID('reports_bic.dbo.GentivaRegional', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.GentivaRegional; 

create table  reports_bic.dbo.GentivaRegional (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Gentiva Region Level' as info
insert into  reports_bic.dbo.GentivaRegional
select ROW_NUMBER() over (order by Provider) as seqno,iHOS,iRgn, 
	...
	Client, Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempGentivaRegional
--get Notes

declare @regcnt as int,@rgn_step as int,@regionname varchar(100)

select @regcnt=count(*) from reports_bic.dbo.GentivaRegional
...
declare @providername varchar(100)
	...
	select @gmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.GentivaRegional where seqno=@rgn_step
	select @providername=  Provider from reports_bic.dbo.GentivaRegional where seqno=@rgn_step


  select @perQ1 = pQ1 from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ2 = pQ2 from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ4m = pQ4m from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ4x = pQ4x from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ4f = pQ4f from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ5m = pQ5m from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ5x = pQ5x from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ5f = pQ5f from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ6m = pQ6m from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ6x = pQ6x from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ6f = pQ6f from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ7m = pQ7m from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ7x = pQ7x from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 
  select @perQ7f = pQ7f from reports_bic.dbo.GentivaRegional where seqno=@rgn_step 



  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Equipment',@perQ1,1-@perQ1,null,@gmonth,@providername);
  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Instruction',@perQ2,1-@perQ2,null,@gmonth,@providername);
  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Delivery Person',@perQ4m, @perQ4f, @perQ4x,@gmonth,@providername);
  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Phone Service',@perQ5m, @perQ5f, @perQ5x,@gmonth,@providername);
  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Timely Delivery',@perQ6m, @perQ6f, @perQ6x,@gmonth,@providername);
  insert into reports_bic.dbo.GentivaQAregionalQuestions values ('Timely Pickup',@perQ7m, @perQ7f, @perQ7x,@gmonth,@providername);
...
IF OBJECT_ID('reports_bic.dbo.GentivaClient', 'U') IS NOT NULL 
  DROP TABLE reports_bic.dbo.GentivaClient; 

create table  reports_bic.dbo.GentivaClient (
	[seqno] [bigint] NULL,
	[iHOS] [int] NULL,
	[iRgn] [int] NULL,
	[iTotal] [int] NULL,
...
select 'Gentiva Client Level' as info
insert into  reports_bic.dbo.GentivaClient
select ROW_NUMBER() over (order by Client) as seqno,iHOS,iRgn, 
	...
	rtrim(Client), Provider,
	dtActualBeginDate,	dtActualEndDate 
from reports_bic.dbo.TempGentivaClient
--get Notes

declare @clientcnt as int,@client_step as int

select @clientcnt=count(*) from reports_bic.dbo.GentivaClient
...
declare @clientname varchar(100)
	...
	select @gcmonth=DATENAME(month ,dtActualBeginDate) from reports_bic.dbo.GentivaClient where seqno=@client_step
	select @cprovidername=  Provider from reports_bic.dbo.GentivaClient where seqno=@client_step
	select @clientname= client from reports_bic.dbo.GentivaClient where seqno=@client_step


  select @percQ1 = pQ1 from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ2 = pQ2 from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ4m = pQ4m from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ4x = pQ4x from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ4f = pQ4f from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ5m = pQ5m from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ5x = pQ5x from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ5f = pQ5f from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ6m = pQ6m from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ6x = pQ6x from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ6f = pQ6f from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ7m = pQ7m from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ7x = pQ7x from reports_bic.dbo.GentivaClient where seqno=@client_step 
  select @percQ7f = pQ7f from reports_bic.dbo.GentivaClient where seqno=@client_step 



  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Equipment',@percQ1,1-@percQ1,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Instruction',@percQ2,1-@percQ2,null,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Delivery person',@percQ4m, @percQ4f, @percQ4x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Phone Service',@percQ5m, @percQ5f, @percQ5x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Timely Delivery',@percQ6m, @percQ6f, @percQ6x,@gcmonth,@cprovidername,@clientname);
  insert into reports_bic.dbo.GentivaQAClientQuestions values ('Timely Pickup',@percQ7m, @percQ7f, @percQ7x,@gcmonth,@cprovidername,@clientname);
